...
plt.plot(years2, upper_middle_income_recent_20_years_ma_trans[1634], label='Thailand')
plt.plot(years3, lower_middle_income_recent_20_years_ma_trans[787], label='Iran')
...
plt.plot(years2, upper_middle_income_recent_20_years_ma_trans[1635], label='Thailand')
plt.plot(years3, lower_middle_income_recent_20_years_ma_trans[788], label='Iran')
plt.plot(years4, poor_recent_20_years_ma_trans[1445], label='Sudan')
...
plt.plot(years6, upper_middle_income_start_20_years_ma_trans[1634], label='Thailand')
plt.plot(years7, lower_middle_income_start_20_years_ma_trans[787], label='Iran')
...
plt.plot(years6, upper_middle_income_start_20_years_ma_trans [1635], label='Thailand')
plt.plot(years7, lower_middle_income_start_20_years_ma_trans [788], label='Iran')
...
plt.plot(years6, upper_middle_income_start_20_years_ma_trans [1637], label='Thailand')
plt.plot(years7, lower_middle_income_start_20_years_ma_trans [790], label='Iran')
plt.plot(years8, poor_start_20_years_ma_trans[1446], label='Sudan')
...
plt.plot(years6, upper_middle_income_recent_20_years_ma_trans [1637], label='Thailand')
plt.plot(years7, lower_middle_income_recent_20_years_ma_trans [790], label='Iran')
plt.plot(years8, poor_recent_20_years_ma_trans[1446], label='Sudan')

plt.xlabel('Year')
plt.ylabel('Value')
plt.title('Agriculutural Land Recent 20 Years Moving Averages')
...
plt.plot(years6, upper_middle_income_start_20_years_ma_trans [1636], label='Thailand')
plt.plot(years7, lower_middle_income_start_20_years_ma_trans [789], label='Iran')
...
plt.plot(years6, upper_middle_income_recent_20_years_ma_trans [1636], label='Thailand')
plt.plot(years7, lower_middle_income_recent_20_years_ma_trans [789], label='Iran')
plt.plot(years8, poor_recent_20_years_ma_trans[1447], label='1448')
...
corr_start_r = rich_start_20_years_ma_trans[283].corr(rich_start_20_years_ma_trans[285]) 
print(corr_start_r)

# Correlation for rich recent 20 years Co2 and forest area
corr_rec_r = rich_recent_20_years_ma_trans[283].corr(rich_recent_20_years_ma_trans[285])
print(corr_rec_r)

# Correlation for upper start 20 years Co2 and forest area 
corr_start_u = upper_middle_income_start_20_years_ma_trans[1634].corr(upper_middle_income_start_20_years_ma_trans[1636])
print(corr_start_u)


#Corr upper start rec 20 Co2 and forest 
corr_rec_u = upper_middle_income_recent_20_years_ma_trans[1634].corr(upper_middle_income_recent_20_years_ma_trans[1636])
print(corr_rec_u)

#corr 
corr_start_l = lower_middle_income_start_20_years_ma_trans[787].corr(lower_middle_income_start_20_years_ma_trans[789])
print(corr_start_l)

#corr
corr_rec_l = lower_middle_income_recent_20_years_ma_trans[787].corr(lower_middle_income_recent_20_years_ma_trans[789])
print(corr_rec_l)

#corr
corr_start_p = poor_start_20_years_ma_trans[1445].corr(poor_start_20_years_ma_trans[1447])
print(corr_start_p)

#corr 
corr_rec_p = poor_recent_20_years_ma_trans[1445].corr(poor_recent_20_years_ma_trans[1447])
print(corr_rec_p)

print('-----------------CO2 AND MORATLITY RATE ------------------------------------')

######## mortality
corr_start_r_m = rich_start_20_years_ma_trans[283].corr(rich_start_20_years_ma_trans[282]) 
print(corr_start_r_m)

# Correlation for rich reecent 20 year co2 and mortality rate 
corr_rec_r_m = rich_recent_20_years_ma_trans[283].corr(rich_recent_20_years_ma_trans[282])
print(corr_rec_r_m)

# Correlation for upper start 20 years mortalit rate 
corr_start_u_m = upper_middle_income_start_20_years_ma_trans[1634].corr(upper_middle_income_start_20_years_ma_trans[1633])
print(corr_start_u_m)


#Corr upper start rec 20 Co2 and mortality rate 
corr_rec_u_m = upper_middle_income_recent_20_years_ma_trans[1634].corr(upper_middle_income_recent_20_years_ma_trans[1633])
print(corr_rec_u_m)

#corr 
corr_start_l_m = lower_middle_income_start_20_years_ma_trans[787].corr(lower_middle_income_start_20_years_ma_trans[786])
print(corr_start_l_m)

#corr
corr_rec_l_m = lower_middle_income_recent_20_years_ma_trans[787].corr(lower_middle_income_recent_20_years_ma_trans[786])
print(corr_rec_l_m)

#corr
corr_start_p_m = poor_start_20_years_ma_trans[1445].corr(poor_start_20_years_ma_trans[1444])
print(corr_start_p_m)

#corr 
corr_rec_p_m = poor_recent_20_years_ma_trans[1445].corr(poor_recent_20_years_ma_trans[1444])
print(corr_rec_p_m)


print('-----------------CO2 AMD ELECTRIC POWER CONSUMPTION----------------------------------')

corr_start_r_e = rich_start_20_years_ma_trans[283].corr(rich_start_20_years_ma_trans[284]) 
print(corr_start_r_e)

# Correlation for rich recent 20 years Co2 and electric power 
corr_rec_r_e = rich_recent_20_years_ma_trans[283].corr(rich_recent_20_years_ma_trans[284])
print(corr_rec_r_e)

# Correlation for upper start 20 years Co2 and fores area 
corr_start_u_e = upper_middle_income_start_20_years_ma_trans[1634].corr(upper_middle_income_start_20_years_ma_trans[1635])
print(corr_start_u_e)


#Corr upper start rec 20 Co2 and forest 
corr_rec_u_e = upper_middle_income_recent_20_years_ma_trans[1634].corr(upper_middle_income_recent_20_years_ma_trans[1635])
print(corr_rec_u_e)

#corr 
corr_start_l_e = lower_middle_income_start_20_years_ma_trans[787].corr(lower_middle_income_start_20_years_ma_trans[788])
print(corr_start_l_e)

#corr
corr_rec_l_e = lower_middle_income_recent_20_years_ma_trans[787].corr(lower_middle_income_recent_20_years_ma_trans[788])
print(corr_rec_l_e)

#corr
corr_start_p_e = poor_start_20_years_ma_trans[1445].corr(poor_start_20_years_ma_trans[1446])
print(corr_start_p_e)

#corr 
corr_rec_p_e = poor_recent_20_years_ma_trans[1445].corr(poor_recent_20_years_ma_trans[1446])
print(corr_rec_p_e)

'''
print(upper_middle_income_start_20_years_ma_trans)
print(lower_middle_income_start_20_years_ma_trans)
print(poor_start_20_years_ma_trans)

print('--------------------------------')

print(rich_recent_20_years_ma_trans)
print(upper_middle_income_recent_20_years_ma_trans)
print(lower_middle_income_recent_20_years_ma_trans)
print(poor_recent_20_years_ma_trans)
'''
